...
Sinatra é uma DSL para criar rapidamente aplicações web em Ruby com mínimo de esforço:
...
No Sinatra, uma rota é um método HTTP associado a uma URL correspondente padrão.
