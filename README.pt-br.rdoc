...
Templates também pdem ser definidos utilizando o  método top-level <tt>template</tt>:
...
Filtros são avaliados antes de cada requisição within the context of the
