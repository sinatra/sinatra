...
Sinatra e uma DSL para criar rapidamente aplicacoes web em Ruby com o minimo de esforco:
...
No Sinatra, uma rota e um metodo HTTP associado a uma URL correspondente padrao.
Cada rota e associada a um bloco:
