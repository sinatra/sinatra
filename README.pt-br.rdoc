...
e substitua em uma base individual.
...
podem ser setadas globalmente através das configurações do sinatra,
veja {Options and Configurations}[http://www.sinatrarb.com/configuration.html],
e substitua em uma base individual.
...
de instância setadas em rotas manipuladas são diretamente acessáveis por templates:
