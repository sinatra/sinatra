...
<table>
  <tr>
    <td>의존</td>
    <td><a href="https://github.com/rtomayko/rdiscount">rdiscount</a>,
                      ...
                      <a href="http://maruku.rubyforge.org/">maruku</a></td>
  </tr>
  <tr>
    <td>파일 확장</td>
...
<dl>
  ...
  <dd>만약 비활성이면, Sinatra는 상대경로 리다이렉트를 허용할 것이지만,
  ...
  <dt>add_charsets<dt>
  <dd><tt>content_type</tt>가 문자셋 정보에 자동으로 추가하게 될 마임(mime) 타입.

                       이 옵션은 오버라이딩하지 말고 추가해야 한다:

                         settings.add_charsets << "application/foobar"</dd>
  ...
  <dt>server<dt>
  <dd>빌트인 서버로 사용할 서버 또는 서버 목록.
                       기본값은 </dd>

['thin', 'mongrel', 'webrick']이며 순서는 우선순위를 의미.
  ...
  <dd>예외 발생 시에 브라우저에 스택 추적을 보임.
                       기본값은 <tt>environment</tt>가 <tt>"development"</tt>인 경우는 활성, 나머지는 비활성.</dd>
