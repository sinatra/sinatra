...
Метод <tt>send_file</tt> также использует автоматическую обработку частичных (range)
...
[default_encoding]    кодировка, если неизвестна
                      (по умолчанию: <tt>"utf-8"</tt>).
...
[run]                 если включено, Sinatra сама будет запускать веб-сервер.
...
[ Ruby 1.8.7 ]
  ...
  этой версии, рекомендуем обновиться до 1.8.2 или перейти на JRuby или Rubinius.
...
Sinatra должна работать на любой операционной системе, поддерживаемой выбранной
реализацией Ruby.
