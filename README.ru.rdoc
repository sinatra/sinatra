...
Этот логгер автоматически учитывает ваши настройки логирования в Rack. Если
логирование выключено, то этот метод вернет объект-пустышку, поэтому вы можете
...
а если ваше приложение -- сабкласс <tt>Sinatra::Base</tt>, то вы, наверное, захотите включить
его вручную:
