...
[scope]
  ...
  приложения. Если вы измените эту опции, то переменные экземпляра и
...
работает отлично для крохотных приложений, но имеет множество недостатков, когда надо создать компоненты,
такие как Rack middleware ("прослойки"), Rails metal, простые библиотеки с серверными компонентами,
расширения Sinatra.
