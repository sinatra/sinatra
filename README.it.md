...
* [Sinatra](#sinatra)
    ...
    * [Views / Templates](#views--templates)
        ...
        * [Linguaggi disponibili per i templates](#available-template-languages)
    ...
    * [Filtri](#filters)
    * [Helpers](#helpers)
        * [Usare le sessioni](#using-sessions)
        * [Halting](#halting)
        * [Passing](#passing)
        * [Innescara una altra route](#triggering-another-route)
        * [Definire il Body, lo Status Coe e gli Headers](#setting-body-status-code-and-headers)
        * [Streaming Responses](#streaming-responses)
        * [Logging](#logging)
        * [Mime Types](#mime-types)
        * [Generare URLs](#generating-urls)
        * [Browser Redirect](#browser-redirect)
        * [Controllare la Cache](#cache-control)
        * [Inviare Files](#sending-files)
        * [Accedere all'oggetto Request](#accessing-the-request-object)
        * [Allegati](#attachments)
        * [Utilizzare Date and Time](#dealing-with-date-and-time)
        * [Ricercare i Template Files](#looking-up-template-files)
    * [Configurazione](#configuration)
        * [Configurare la protezione per gli attacchi(attack protection)](#configuring-attack-protection)
        * [Configurazioni disponibili](#available-settings)
    ...
    * [Testare](#testing)
    * [Sinatra::Base - Middleware, Librerie, and Abbplicazioni Modulari](#sinatrabase---middleware-libraries-and-modular-apps)
        * [Modulare vs. Classic Style](#modular-vs-classic-style)
        * [Fornire un applicazione modulare](#serving-a-modular-application)
        * [Usare una Classic Style Application con config.ru](#using-a-classic-style-application-with-a-configru)
        * [Quando utilizzare config.ru?](#when-to-use-a-configru)
        * [Utilizzare Sinatra come Middleware](#using-sinatra-as-middleware)
        * [Creazione dinamica di applicazioni](#dynamic-application-creation)
    * [Scopes e Binding](#scopes-and-binding)
        * [Application/Class Scope](#applicationclass-scope)
        * [Request/Instance Scope](#requestinstance-scope)
        * [Delegation Scope](#delegation-scope)
    * [Linea di comando](#command-line)
    * [Requisiti](#requirement)
    * [The Bleeding Edge](#the-bleeding-edge)
        * [Con Bundler](#with-bundler)
        * [Fai da te](#roll-your-own)
        * [Installazione Globale](#install-globally)
    * [Versioning](#versioning)
    * [Voci correlate](#further-reading)

## Routes(instradamento)

In Sinatra, una route é un metodo HTTP collegato con un pattern URL.
